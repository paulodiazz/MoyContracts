 ...
 * To update run 'ampli pull neftalina'
 *
 ...
 *
 * [View Tracking Plan](https://data.amplitude.com/neftalina/NeFTalina/events/main/latest)
 *
 * [Full Setup Instructions](https://data.amplitude.com/neftalina/NeFTalina/implementation/neftalina)
 */
...
export type Environment = 'unnamedenvironment';

export const ApiKey: Record<Environment, string> = {
  unnamedenvironment: '05087ac83c74f3170378446966cd508d'
};
...
export const DefaultConfiguration: NodeOptions = {
  plan: {
    ...
    branch: 'main',
    source: 'neftalina',
    versionId: '40465f4b-a81d-45c8-8d3b-d2f1b1cf80b2'
  },
  ...{
    ingestionMetadata: {
...
export class UserVisited implements BaseEvent {
  event_type = 'User Visited';
}
...
export class Ampli {
   ...
   * User Visited
   *
   * [View in Tracking Plan](https://data.amplitude.com/neftalina/NeFTalina/events/main/latest/User%20Visited)
   *
   * Owner: Paulo Diaz
   *
   * @param userId The user's ID.
  ...
  userVisited(
    ...
    return this.track(userId, new UserVisited(), options);
  }
}
